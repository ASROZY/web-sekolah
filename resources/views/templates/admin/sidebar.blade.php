<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html"
            target="_blank">
            <img src="{{ asset('soft/assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">SMP Terpadu Darur Roja</span>
        </a>
    </div>
            ...
            @if (Auth::user()->type == 2 or Auth::user()->type == 3)
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples"
                        class="nav-link {{ request()->segment(1) == 'ppdb' ? 'active' : '' }}"
                    ...
                    <div class="collapse {{ request()->segment(1) == 'ppdb' ? 'show' : '' }}" id="pagesExamples">
                        <ul class="nav ms-4 ps-3">
                            @if (Auth::user()->type == 2)
                                <li class="nav-item ">
                                    <a class="nav-link {{ request()->segment(2) == 'pendaftar' ? 'active' : '' }}"
                                        href="{{ url('ppdb/pendaftar') }}">
                                        <span class="sidenav-mini-icon"> P </span>
                                        <span class="sidenav-normal"> Pendaftar </span>
                                    </a>
                                </li>
                            @endif
                            @if (Auth::user()->type == 3)
                                <li class="nav-item ">
                                    <a class="nav-link {{ request()->segment(2) == 'daftar' ? 'active' : '' }}"
                                        href="{{ url('ppdb/daftar') }}">
                                        <span class="sidenav-mini-icon"> P </span>
                                        <span class="sidenav-normal"> Pendaftaran PPDB</span>
                                    </a>
                                </li>
                            @endif
                        </ul>
