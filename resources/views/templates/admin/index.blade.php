...
<head>
    ...
    <title>
        {{ $title }} | Admin Panel SMP Terpadu Darur Roja
    </title>
    <!--     Fonts and icons     -->
    ...
    <link href="{{ asset('soft/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('soft/assets/css/soft-ui-dashboard.css') }}" rel="stylesheet" />
    @stack('css')
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <script src="{{ asset('soft/assets/js/soft-ui-dashboard.min.js') }}"></script>
    @stack('js')
</body>
