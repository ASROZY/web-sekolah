                ...
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        ...
                        @foreach ($album as $item)
                            <li data-filter=".filter-{{ $item->id }}">{{ $item->album }}</li>
                        @endforeach
                    </ul>
                </div>
            </div>
                    ...
                    @foreach ($item->foto as $galeri)
                        <div class="col-lg-4 col-md-6 portfolio-item filter-{{ $item->id }}">
                            <div class="portfolio-wrap">
                                <img src="{{ asset($galeri->img) }}" class="img-fluid"
                                    alt="{{ asset($galeri->img) }}">
                                <div class="portfolio-info">
                                    <h4>{{ asset($item->album) }}</h4>
                                    <p>{{ asset($galeri->keterangan) }}</p>
                                    <div class="portfolio-links">
                                        <a href="{{ asset($galeri->img) }}" data-gallery="portfolioGallery"
                                            class="portfolio-lightbox" title="{{ asset($galeri->img) }}"><i
                ...
                <div class="col-lg-6">
                    <div class="info">
                        ...
                        <div class="email">
                            ...
                            <h4>Email:</h4>
                            <p>smpterpadudarurroja@gmail.com</p>
                        </div>
